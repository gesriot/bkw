...
def _legacy_page1_modes(d: BKWData) -> None:
    ...
    while True:
        ...
        print(f"(1) Perform input equilibrium calculation: {_yesno(d.ioeq == 1)}")
...
def run_cli(argv: list[str] | None = None) -> int:
    ...
    # Explicit command-line values win over defaults and over values inferred
    # from a mixture, e.g. --mix can estimate rho/label but --set-rho/--set-label
