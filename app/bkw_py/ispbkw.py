...
def run(
    ...
    *,
    ...
    """Run ISPBKW via the bundled native engine (``abispbkw``).

    ``cfg`` is accepted for signature compatibility but ignored: the native
    engine reads all run constants from BKWDATA.
    """
...
def run_python(
    ...
    *,
    ...
    """Legacy pure-Python ISPBKW implementation, kept as a numerical reference."""
